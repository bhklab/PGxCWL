...
#load("/pfs/GRAY_Normalized2017Pipeline/drug_norm2017.RData")
...
save(raw.sensitivity, sensitivity.info, tt, con_tested, file="/pfs/out/drug_norm_post2017.RData")
...
save(recomputed, file="/Users/anthonymammoliti/Desktop/GRAY_sens_recomputed2017.RData")
