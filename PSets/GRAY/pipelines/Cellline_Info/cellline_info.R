...
cellineinfo <- rbind(cellineinfo, c("SUM 190", "breast", "NA", "NA", "NA","NA","NA","NA","NA","NA","NA", "NA" ))
rownames(cellineinfo)[85] <- "SUM 190"

cellineinfo <- rbind(cellineinfo, c("HCC1500", "breast", "NA", "NA", "NA","NA","NA","NA","NA","NA","NA","NA" ))
rownames(cellineinfo)[86] <- "HCC1500"

cellineinfo <- rbind(cellineinfo, c("DU-4475", "breast", "NA", "NA", "NA","NA","NA","NA","NA","NA","NA","NA" ))
rownames(cellineinfo)[87] <- "DU-4475"

cellineinfo <- rbind(cellineinfo, c("HCC1007", "breast", "NA", "NA", "NA","NA","NA","NA","NA","NA","NA","NA" ))
rownames(cellineinfo)[88] <- "HCC1007"

cellineinfo <- rbind(cellineinfo, c("MDA-MB-435", "breast", "NA", "NA", "NA","NA","NA","NA","NA","NA","NA","NA" ))
rownames(cellineinfo)[89] <- "MDA-MB-435"

cellineinfo <- rbind(cellineinfo, c("HCC2157", "breast", "NA", "NA", "NA","NA","NA","NA","NA","NA","NA","NA" ))
rownames(cellineinfo)[90] <- "HCC2157"

cellineinfo <- rbind(cellineinfo, c("184A1N4", "breast", "NA", "NA", "NA","NA","NA","NA","NA","NA","NA","NA" ))
