...
badchars <- "[\xb5]|[]|[ ,]|[;]|[:]|[-]|[+]|[*]|[%]|[$]|[#]|[{]|[}]|[[]|[]]|[|]|[\\^]|[/]|[\\]|[.]|[_]|[ ]"
U133Aexp = commandArgs(trailingOnly=TRUE)[1]
U133Ainfo = commandArgs(trailingOnly=TRUE)[2]
U133Afeature = commandArgs(trailingOnly=TRUE)[3]

Exonexp = commandArgs(trailingOnly=TRUE)[4]
Exoninfo = commandArgs(trailingOnly=TRUE)[5]
Exonfeature = commandArgs(trailingOnly=TRUE)[6]
